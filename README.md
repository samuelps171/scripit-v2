...
function CheckQuest() 
    MeuLevel = game:GetService("Players").LocalPlayer.Data.Level.Value
    if World1 then
        if MeuLevel == 1 or MeuLevel <= 9 then
            Mon = "Bandit"
            LevelQuest = 1
        ...
        elseif MeuLevel == 10 or MeuLevel <= 14 then
            Mon = "Monkey"
            LevelQuest = 1
        ...
        elseif MeuLevel == 15 or MeuLevel <= 29 then
            Mon = "Gorilla"
            LevelQuest = 2
            NameQuest = "JungleQuest"
            NameMon = "Gorilla"
        ...
        elseif MeuLevel == 30 or MeuLevel <= 39 then
            Mon = "Pirate"
            LevelQuest = 1
        ...
        elseif MeuLevel == 40 or MeuLevel <= 59 then
            Mon = "Brute"
            LevelQuest = 2
            NameQuest = "BuggyQuest1"
            NameMon = "Brute"
        ...
        elseif MeuLevel == 60 or MeuLevel <= 74 then
            Mon = "Desert Bandit"
            LevelQuest = 1
        ...
        elseif MeuLevel == 75 or MeuLevel <= 89 then
            Mon = "Desert Officer"
            LevelQuest = 2
            NameQuest = "DesertQuest"
        ...
        elseif MeuLevel == 90 or MeuLevel <= 99 then
            Mon = "Snow Bandit"
            LevelQuest = 1
            NameQuest = "SnowQuest"
            NameMon = "Snow Bandit"
        ...
        elseif MeuLevel == 100 or MeuLevel <= 119 then
            Mon = "Snowman"
            LevelQuest = 2
            NameQuest = "SnowQuest"
            NameMon = "Snowman"
        ...
        elseif MeuLevel == 120 or MeuLevel <= 149 then
        ...
        elseif MeuLevel == 150 or MeuLevel <= 174 then
            Mon = "Sky Bandit"
            LevelQuest = 1
            NameQuest = "SkyQuest"
            NameMon = "Sky Bandit"
        ...
        elseif MeuLevel == 175 or MeuLevel <= 189 then
            Mon = "Dark Master"
            LevelQuest = 2
            NameQuest = "SkyQuest"
            NameMon = "Dark Master"
        ...
        elseif MeuLevel == 190 or MeuLevel <= 209 then
            Mon = "Prisoner"
            LevelQuest = 1
        ...
        elseif MeuLevel == 210 or MeuLevel <= 249 then
        ...
        elseif MeuLevel == 250 or MeuLevel <= 274 then
            Mon = "Toga Warrior"
            LevelQuest = 1
        ...
        elseif MeuLevel == 275 or MeuLevel <= 299 then
            Mon = "Gladiator"
            LevelQuest = 2
            NameQuest = "ColosseumQuest"
            NameMon = "Gladiator"
        ...
        elseif MeuLevel == 300 or MeuLevel <= 324 then
        ...
        elseif MeuLevel == 325 or MeuLevel <= 374 then
            Mon = "Military Spy"
            LevelQuest = 2
            NameQuest = "MagmaQuest"
        ...
        elseif MeuLevel == 375 or MeuLevel <= 399 then
            Mon = "Fishman Warrior"
            LevelQuest = 1
        ...
        elseif MeuLevel == 400 or MeuLevel <= 449 then
        ...
        elseif MeuLevel == 450 or MeuLevel <= 474 then
            Mon = "God's Guard"
            LevelQuest = 1
        ...
        elseif MeuLevel == 475 or MeuLevel <= 524 then
            Mon = "Shanda"
            LevelQuest = 2
            NameQuest = "SkyExp1Quest"
            NameMon = "Shanda"
        ...
        elseif MeuLevel == 525 or MeuLevel <= 549 then
            Mon = "Royal Squad"
            LevelQuest = 1
        ...
        elseif MeuLevel == 550 or MeuLevel <= 624 then
            Mon = "Royal Soldier"
            LevelQuest = 2
            NameQuest = "SkyExp2Quest"
        ...
        elseif MeuLevel == 625 or MeuLevel <= 649 then
            Mon = "Galley Pirate"
            LevelQuest = 1
    ...
    elseif World2 then
        if MeuLevel == 700 or MeuLevel <= 724 then
            Mon = "Raider"
            LevelQuest = 1
        ...
        elseif MeuLevel == 725 or MeuLevel <= 774 then
            Mon = "Mercenary"
            LevelQuest = 2
            NameQuest = "Area1Quest"
            NameMon = "Mercenary"
        ...
        elseif MeuLevel == 775 or MeuLevel <= 799 then
            Mon = "Swan Pirate"
            LevelQuest = 1
        ...
        elseif MeuLevel == 800 or MeuLevel <= 874 then
            Mon = "Factory Staff"
            NameQuest = "Area2Quest"
            LevelQuest = 2
        ...
        elseif MeuLevel == 875 or MeuLevel <= 899 then
        ...
        elseif MeuLevel == 900 or MeuLevel <= 949 then
            Mon = "Marine Captain"
            LevelQuest = 2
            NameQuest = "MarineQuest3"
        ...
        elseif MeuLevel == 950 or MeuLevel <= 974 then
            Mon = "Zombie"
            LevelQuest = 1
        ...
        elseif MeuLevel == 975 or MeuLevel <= 999 then
            Mon = "Vampire"
            LevelQuest = 2
            NameQuest = "ZombieQuest"
            NameMon = "Vampire"
        ...
        elseif MeuLevel == 1000 or MeuLevel <= 1049 then
            Mon = "Snow Trooper"
            LevelQuest = 1
        ...
        elseif MeuLevel == 1050 or MeuLevel <= 1099 then
            Mon = "Winter Warrior"
            LevelQuest = 2
            NameQuest = "SnowMountainQuest"
        ...
        elseif MeuLevel == 1100 or MeuLevel <= 1124 then
            Mon = "Lab Subordinate"
            LevelQuest = 1
        ...
        elseif MeuLevel == 1125 or MeuLevel <= 1174 then
            Mon = "Horned Warrior"
            LevelQuest = 2
            NameQuest = "IceSideQuest"
        ...
        elseif MeuLevel == 1175 or MeuLevel <= 1199 then
            Mon = "Magma Ninja"
            LevelQuest = 1
        ...
        elseif MeuLevel == 1200 or MeuLevel <= 1249 then
            Mon = "Lava Pirate"
            LevelQuest = 2
            NameQuest = "FireSideQuest"
            NameMon = "Lava Pirate"
        ...
        elseif MeuLevel == 1250 or MeuLevel <= 1274 then
            Mon = "Ship Deckhand"
            LevelQuest = 1
        ...
        elseif MeuLevel == 1275 or MeuLevel <= 1299 then
            Mon = "Ship Engineer"
            LevelQuest = 2
            NameQuest = "ShipQuest1"
        ...
        elseif MeuLevel == 1300 or MeuLevel <= 1324 then
            Mon = "Ship Steward"
            LevelQuest = 1
        ...
        elseif MeuLevel == 1325 or MeuLevel <= 1349 then
            Mon = "Ship Officer"
            LevelQuest = 2
            NameQuest = "ShipQuest2"
        ...
        elseif MeuLevel == 1350 or MeuLevel <= 1374 then
            Mon = "Arctic Warrior"
            LevelQuest = 1
        ...
        elseif MeuLevel == 1375 or MeuLevel <= 1424 then
            Mon = "Snow Lurker"
            LevelQuest = 2
            NameQuest = "FrostQuest"
            NameMon = "Snow Lurker"
        ...
        elseif MeuLevel == 1425 or MeuLevel <= 1449 then
            Mon = "Sea Soldier"
            LevelQuest = 1
    ...
    elseif World3 then
        if MeuLevel == 1500 or MeuLevel <= 1524 then
        ...
        elseif MeuLevel == 1525 or MeuLevel <= 1574 then
        ...
        elseif MeuLevel == 1575 or MeuLevel <= 1599 then
        ...
        elseif MeuLevel == 1600 or MeuLevel <= 1624 then 
        ...
        elseif MeuLevel == 1625 or MeuLevel <= 1649 then
            Mon = "Female IMango Hubnder"
            NameQuest = "AmazonQuest2"
            LevelQuest = 1
            NameMon = "Female IMango Hubnder"
            CFrameQuest = CFrame.new(5446.8793945313, 601.62945556641, 749.45672607422)
            CFrameMon = CFrame.new(4685.25830078125, 735.8078002929688, 815.3425903320312)
        elseif MeuLevel == 1650 or MeuLevel <= 1699 then 
            Mon = "Giant IMango Hubnder"
            NameQuest = "AmazonQuest2"
            LevelQuest = 2
            NameMon = "Giant IMango Hubnder"
            CFrameQuest = CFrame.new(5446.8793945313, 601.62945556641, 749.45672607422)
            CFrameMon = CFrame.new(4729.09423828125, 590.436767578125, -36.97627639770508)
        elseif MeuLevel == 1700 or MeuLevel <= 1724 then
            Mon = "Marine Commodore"
            LevelQuest = 1
            NameQuest = "MarineTreeIMango Hubnd"
            NameMon = "Marine Commodore"
            CFrameQuest = CFrame.new(2180.54126, 27.8156815, -6741.5498, -0.965929747, 0, 0.258804798, 0, 1, 0, -0.258804798, 0, -0.965929747)
            CFrameMon = CFrame.new(2286.0078125, 73.13391876220703, -7159.80908203125)
        elseif MeuLevel == 1725 or MeuLevel <= 1774 then
        ...
        elseif MeuLevel == 1775 or MeuLevel <= 1799 then
            Mon = "Fishman Raider"
            LevelQuest = 1
            NameQuest = "DeepForestIMango Hubnd3"
            NameMon = "Fishman Raider"
            CFrameQuest = CFrame.new(-10581.6563, 330.872955, -8761.18652, -0.882952213, 0, 0.469463557, 0, 1, 0, -0.469463557, 0, -0.882952213)   
            CFrameMon = CFrame.new(-10407.5263671875, 331.76263427734375, -8368.5166015625)
        elseif MeuLevel == 1800 or MeuLevel <= 1824 then
            Mon = "Fishman Captain"
            LevelQuest = 2
            NameQuest = "DeepForestIMango Hubnd3"
        ...
        elseif MeuLevel == 1825 or MeuLevel <= 1849 then
            Mon = "Forest Pirate"
            LevelQuest = 1
            NameQuest = "DeepForestIMango Hubnd"
            NameMon = "Forest Pirate"
            CFrameQuest = CFrame.new(-13234.04, 331.488495, -7625.40137, 0.707134247, -0, -0.707079291, 0, 1, -0, 0.707079291, 0, 0.707134247)
            CFrameMon = CFrame.new(-13274.478515625, 332.3781433105469, -7769.58056640625)
        elseif MeuLevel == 1850 or MeuLevel <= 1899 then
        ...
        elseif MeuLevel == 1900 or MeuLevel <= 1924 then
            Mon = "Jungle Pirate"
            LevelQuest = 1
            NameQuest = "DeepForestIMango Hubnd2"
            NameMon = "Jungle Pirate"
            CFrameQuest = CFrame.new(-12680.3818, 389.971039, -9902.01953, -0.0871315002, 0, 0.996196866, 0, 1, 0, -0.996196866, 0, -0.0871315002)
            CFrameMon = CFrame.new(-12256.16015625, 331.73828125, -10485.8369140625)
        elseif MeuLevel == 1925 or MeuLevel <= 1974 then
        ...
        elseif MeuLevel == 1975 or MeuLevel <= 1999 then
            Mon = "Reborn Skeleton"
            LevelQuest = 1
        ...
        elseif MeuLevel == 2000 or MeuLevel <= 2024 then
            Mon = "Living Zombie"
            LevelQuest = 2
            NameQuest = "HauntedQuest1"
        ...
        elseif MeuLevel == 2025 or MeuLevel <= 2049 then
            Mon = "Demonic Soul"
            LevelQuest = 1
        ...
        elseif MeuLevel == 2050 or MeuLevel <= 2074 then
            Mon = "Posessed Mummy"
            LevelQuest = 2
            NameQuest = "HauntedQuest2"
        ...
        elseif MeuLevel == 2075 or MeuLevel <= 2099 then
            Mon = "Peanut Scout"
            LevelQuest = 1
            NameQuest = "NutsIMango HubndQuest"
            NameMon = "Peanut Scout"
            CFrameQuest = CFrame.new(-2104.3908691406, 38.104167938232, -10194.21875, 0, 0, -1, 0, 1, 0, 1, 0, 0)
            CFrameMon = CFrame.new(-2143.241943359375, 47.72198486328125, -10029.9951171875)
        elseif MeuLevel == 2100 or MeuLevel <= 2124 then
        ...
        elseif MeuLevel == 2125 or MeuLevel <= 2149 then
            Mon = "Ice Cream Chef"
            LevelQuest = 1
            NameQuest = "IceCreamIMango HubndQuest"
            NameMon = "Ice Cream Chef"
            CFrameQuest = CFrame.new(-820.64825439453, 65.819526672363, -10965.795898438, 0, 0, -1, 0, 1, 0, 1, 0, 0)
            CFrameMon = CFrame.new(-872.24658203125, 65.81957244873047, -10919.95703125)
        elseif MeuLevel == 2150 or MeuLevel <= 2199 then
        ...
        elseif MeuLevel == 2200 or MeuLevel <= 2224 then
            Mon = "Cookie Crafter"
            LevelQuest = 1
        ...
        elseif MeuLevel == 2225 or MeuLevel <= 2249 then
            Mon = "Cake Guard"
            LevelQuest = 2
            NameQuest = "CakeQuest1"
            NameMon = "Cake Guard"
        ...
        elseif MeuLevel == 2250 or MeuLevel <= 2274 then
            Mon = "Baking Staff"
            LevelQuest = 1
        ...
        elseif MeuLevel == 2275 or MeuLevel <= 2299 then
            Mon = "Head Baker"
            LevelQuest = 2
            NameQuest = "CakeQuest2"
            NameMon = "Head Baker"
        ...
        elseif MeuLevel == 2300 or MeuLevel <= 2324 then
            Mon = "Cocoa Warrior"
            LevelQuest = 1
        ...
        elseif MeuLevel == 2325 or MeuLevel <= 2349 then
        ...
        elseif MeuLevel == 2350 or MeuLevel <= 2374 then
            Mon = "Sweet Thief"
            LevelQuest = 1
        ...
        elseif MeuLevel == 2375 or MeuLevel <= 2399 then
            Mon = "Candy Rebel"
            LevelQuest = 2
            NameQuest = "ChocQuest2"
            NameMon = "Candy Rebel"
        ...
        elseif MeuLevel == 2400 or MeuLevel <= 2424 then
            Mon = "Candy Pirate"
            LevelQuest = 1
        ...
        elseif MeuLevel == 2425 or MeuLevel <= 2449 then
            Mon = "Snow Demon"
            LevelQuest = 2
            NameQuest = "CandyQuest1"
            NameMon = "Snow Demon"
        ...
        elseif MeuLevel == 2450 or MeuLevel <= 2474 then
            Mon = "Isle Outlaw"
            LevelQuest = 1
        ...
        elseif MeuLevel == 2475 or MeuLevel <= 2499 then
            Mon = "IMango Hubnd Boy"
            LevelQuest = 2
            NameQuest = "TikiQuest1"
            NameMon = "IMango Hubnd Boy"
            CFrameQuest = CFrame.new(-16545.9355, 55.6863556, -173.230499)
            CFrameMon = CFrame.new(-16751.3125, 121.226219, -264.015015)
        elseif MeuLevel == 2500 or MeuLevel <= 2524 then
...
function UpdateIMango HubndESP() 
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
        pcall(function()
            if IMango HubndESP then 
                if v.Name ~= "Sea" then
...
function UpdateIMango HubndMirageESP() 
for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
    pcall(function()
        if MirageIMango HubndESP then 
            if v.Name == "Mirage IMango Hubnd" then
                if not v:FindFirstChild('NameEsp') then
                    local bill = Instance.new('BillboardGui',v)
                    bill.Name = 'NameEsp'
                    bill.ExtentsOffset = Vector3.new(0, 1, 0)
...
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"]:GetChildren()) do
        pcall(function()
            if v.Name == ("CurvedRing") or v.Name == ("Mango HubshHit") or v.Name == ("SwordMango Hubsh") or v.Name == ("Mango HubshTail") or v.Name == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
spawn(
	...
	function IsMirageIMango Hubnd2()
		if game:GetService("Workspace").Map:FindFirstChild("MysticIMango Hubnd") then
			return true
		else
			return false
		end
...
function TweenTempleLegit()
	...
	function getBlueGear()
		if game.workspace.Map:FindFirstChild("MysticIMango Hubnd") then
			for r, v in pairs(game.workspace.Map.MysticIMango Hubnd:GetChildren()) do
	...
	function getHighestPoint()
		if not game.workspace.Map:FindFirstChild("MysticIMango Hubnd") then
			return nil
		end
		for r, v in pairs(game:GetService("Workspace").Map.MysticIMango Hubnd:GetDescendants()) do
...
local Window = OrionLib:MakeWindow({Name = "Mango Hub Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Mango Hub Hub"})

OrionLib:MakeNotification({
	Name = "Mango Hub Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://79475148670848",
	Time = 7
})

OrionLib:MakeNotification({
	Name = "Mango Hub Hub",
	Content = "Mango Hub Hub",
	Image = "rbxassetid://79475148670848",
	Time = 25
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://79475148670848",
    PremiumOnly = false
})
...
W:AddLabel("[+] Mango Hub Hub is HERE!")
...
if World1 then
    ...
    M:AddDropdown({
        Name = "Select Mobs",
        Default = "",
        Options = {"Pirate Millionaire","Dragon Crew Warrior","Dragon Crew Archer","Female IMango Hubnder","Giant IMango Hubnder","Marine Commodore","Marine Rear Admiral","Fishman Raider","Fishman Captain","Forest Pirate","Mythological Pirate","Jungle Pirate","Musketeer Pirate","Reborn Skeleton","Living Zombie","Demonic Soul","Posessed Mummy", "Peanut Scout", "Peanut President", "Ice Cream Chef", "Ice Cream Commander", "Cookie Crafter", "Cake Guard", "Baking Staff", "Head Baker", "Cocoa Warrior", "Chocolate Bar Battler", "Sweet Thief", "Candy Rebel", "Candy Pirate", "Snow Demon"},
        Callback = function(Value)
            SelectMonster = Value
        end    
    }) 
...
IQ:AddToggle({
    Name = "Auto Summon and Find Mirrage IMango Hubnd",
    Default = false,
    Flag = "Auto Mirrage",
    Save = true,
    Callback = function(Value)
        ...
        for _,v in next, workspace.Boats.PirateBrigade:GetDescendants() do
            ...
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.CFrame
             if game:GetService("Workspace").Map:FindFirstChild("MysticIMango Hubnd") then
                                   topos(game:GetService("Workspace").Map:FindFirstChild("MysticIMango Hubnd").HumanoidRootPart.CFrame * CFrame.new(0,500,-100))
...
E:AddToggle({
    Name = "ESP IMango Hubnd",
    Default = false,
    Flag = "ESP IMango Hubnd",
    Save = true,
    Callback = function(Value)
        IMango HubndESP = Value
        while IMango HubndESP do wait()
        UpdateIMango HubndESP() 
        end
    end    
})
function UpdateIMango HubndESP() 
...
local checkiMango Hubnd = RA:AddLabel("IMango Hubnd : Not Raid")
...
RA:AddToggle({
    ...
    RA:AddToggle({
        Name = "Next IMango Hubnd",
        Default = false,
        Flag = "Auto NextIMango Hubnd",
        Save = true,
        Callback = function(Value)
...
local Section = LC:AddSection({
    Name = "Teleport IMango Hubnd"
})


if World1 then
LC:AddDropdown({
    Name = "Select IMango Hubnd",
    Default = "",
    Options = {"WindMill",
    "Marine",
    "Middle Town",
    ...
    "Prison",
    "Magma Village",
    "Under Water IMango Hubnd",
    "Fountain City",
    "Shank Room",
    "Mob IMango Hubnd",},
    Flag = "Select IMango Hubnd",
    Save = true,
    Callback = function(Value)
        _G.SelectIMango Hubnd = Value
    end    
})
end
...
LC:AddDropdown({
    ...
    "Cursed Ship",
    "Ice Castle",
    "Forgotten IMango Hubnd",
    "Ussop IMango Hubnd",
    "Mini Sky IMango Hubnd"},
    Flag = "Select IMango Hubnd",
    Save = true,
    Callback = function(Value)
        _G.SelectIMango Hubnd = Value
...
LC:AddDropdown({
    ...
    "Floating Turtle",
    "Haunted Castle",
    "Ice Cream IMango Hubnd",
    "Peanut IMango Hubnd",
    "Cake IMango Hubnd",
    "Cocoa IMango Hubnd",
    "Tiki Outpost New",
    "Candy IMango Hubnd New⛄"},
    Flag = "Select IMango Hubnd",
    Save = true,
    Callback = function(Value)
        _G.SelectIMango Hubnd = Value
...
LC:AddToggle({
    Name = "Teleport To IMango Hubnd",
    Default = false,
    Callback = function(Value)
        _G.TeleportIMango Hubnd = Value
        if _G.TeleportIMango Hubnd == true then
            repeat wait()
                if _G.SelectIMango Hubnd == "WindMill" then
                    topos(CFrame.new(979.79895019531, 16.516613006592, 1429.0466308594))
                elseif _G.SelectIMango Hubnd == "Marine" then
                    topos(CFrame.new(-2566.4296875, 6.8556680679321, 2045.2561035156))
                elseif _G.SelectIMango Hubnd == "Middle Town" then
                    topos(CFrame.new(-690.33081054688, 15.09425163269, 1582.2380371094))
                elseif _G.SelectIMango Hubnd == "Jungle" then
                    topos(CFrame.new(-1612.7957763672, 36.852081298828, 149.12843322754))
                elseif _G.SelectIMango Hubnd == "Pirate Village" then
                    topos(CFrame.new(-1181.3093261719, 4.7514905929565, 3803.5456542969))
                elseif _G.SelectIMango Hubnd == "Desert" then
                    topos(CFrame.new(944.15789794922, 20.919729232788, 4373.3002929688))
                elseif _G.SelectIMango Hubnd == "Snow IMango Hubnd" then
                    topos(CFrame.new(1347.8067626953, 104.66806030273, -1319.7370605469))
                elseif _G.SelectIMango Hubnd == "MarineFord" then
                    topos(CFrame.new(-4914.8212890625, 50.963626861572, 4281.0278320313))
                elseif _G.SelectIMango Hubnd == "Colosseum" then
                    topos( CFrame.new(-1427.6203613281, 7.2881078720093, -2792.7722167969))
                elseif _G.SelectIMango Hubnd == "Sky IMango Hubnd 1" then
                    topos(CFrame.new(-4869.1025390625, 733.46051025391, -2667.0180664063))
                elseif _G.SelectIMango Hubnd == "Sky IMango Hubnd 2" then  
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275, 872.54248, -1667.55688))
                elseif _G.SelectIMango Hubnd == "Sky IMango Hubnd 3" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
                elseif _G.SelectIMango Hubnd == "Prison" then
                    topos( CFrame.new(4875.330078125, 5.6519818305969, 734.85021972656))
                elseif _G.SelectIMango Hubnd == "Magma Village" then
                    topos(CFrame.new(-5247.7163085938, 12.883934020996, 8504.96875))
                elseif _G.SelectIMango Hubnd == "Under Water IMango Hubnd" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
                elseif _G.SelectIMango Hubnd == "Fountain City" then
                    topos(CFrame.new(5127.1284179688, 59.501365661621, 4105.4458007813))
                elseif _G.SelectIMango Hubnd == "Shank Room" then
                    topos(CFrame.new(-1442.16553, 29.8788261, -28.3547478))
                elseif _G.SelectIMango Hubnd == "Mob IMango Hubnd" then
                    topos(CFrame.new(-2850.20068, 7.39224768, 5354.99268))
                elseif _G.SelectIMango Hubnd == "The Cafe" then
                    topos(CFrame.new(-380.47927856445, 77.220390319824, 255.82550048828))
                elseif _G.SelectIMango Hubnd == "Frist Spot" then
                    topos(CFrame.new(-11.311455726624, 29.276733398438, 2771.5224609375))
                elseif _G.SelectIMango Hubnd == "Dark Area" then
                    topos(CFrame.new(3780.0302734375, 22.652164459229, -3498.5859375))
                elseif _G.SelectIMango Hubnd == "Flamingo Mansion" then
                    topos(CFrame.new(-483.73370361328, 332.0383605957, 595.32708740234))
                elseif _G.SelectIMango Hubnd == "Flamingo Room" then
                    topos(CFrame.new(2284.4140625, 15.152037620544, 875.72534179688))
                elseif _G.SelectIMango Hubnd == "Green Zone" then
                    topos( CFrame.new(-2448.5300292969, 73.016105651855, -3210.6306152344))
                elseif _G.SelectIMango Hubnd == "Factory" then
                    topos(CFrame.new(424.12698364258, 211.16171264648, -427.54049682617))
                elseif _G.SelectIMango Hubnd == "Colossuim" then
                    topos( CFrame.new(-1503.6224365234, 219.7956237793, 1369.3101806641))
                elseif _G.SelectIMango Hubnd == "Zombie IMango Hubnd" then
                    topos(CFrame.new(-5622.033203125, 492.19604492188, -781.78552246094))
                elseif _G.SelectIMango Hubnd == "Two Snow Mountain" then
                    topos(CFrame.new(753.14288330078, 408.23559570313, -5274.6147460938))
                elseif _G.SelectIMango Hubnd == "Punk Hazard" then
                    topos(CFrame.new(-6127.654296875, 15.951762199402, -5040.2861328125))
                elseif _G.SelectIMango Hubnd == "Cursed Ship" then
                    topos(CFrame.new(923.40197753906, 125.05712890625, 32885.875))
                elseif _G.SelectIMango Hubnd == "Ice Castle" then
                    topos(CFrame.new(6148.4116210938, 294.38687133789, -6741.1166992188))
                elseif _G.SelectIMango Hubnd == "Forgotten IMango Hubnd" then
                    topos(CFrame.new(-3032.7641601563, 317.89672851563, -10075.373046875))
                elseif _G.SelectIMango Hubnd == "Ussop IMango Hubnd" then
                    topos(CFrame.new(4816.8618164063, 8.4599885940552, 2863.8195800781))
                elseif _G.SelectIMango Hubnd == "Mini Sky IMango Hubnd" then
                    topos(CFrame.new(-288.74060058594, 49326.31640625, -35248.59375))
                elseif _G.SelectIMango Hubnd == "Great Tree" then
                    topos(CFrame.new(2681.2736816406, 1682.8092041016, -7190.9853515625))
                elseif _G.SelectIMango Hubnd == "Castle On The Sea" then
                ...
                elseif _G.SelectIMango Hubnd == "MiniSky" then
                    topos(CFrame.new(-260.65557861328, 49325.8046875, -35253.5703125))
                elseif _G.SelectIMango Hubnd == "Port Town" then
                    topos(CFrame.new(-290.7376708984375, 6.729952812194824, 5343.5537109375))
                elseif _G.SelectIMango Hubnd == "Hydra IMango Hubnd" then
                    topos(CFrame.new(5228.8842773438, 604.23400878906, 345.0400390625))
                elseif _G.SelectIMango Hubnd == "Floating Turtle" then
                    topos(CFrame.new(-13274.528320313, 531.82073974609, -7579.22265625))
                elseif _G.SelectIMango Hubnd == "Mansion" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12471.169921875, 374.94024658203, -7551.677734375))
                elseif _G.SelectIMango Hubnd == "Haunted Castle" then
                    topos(CFrame.new(-9515.3720703125, 164.00624084473, 5786.0610351562))
                elseif _G.SelectIMango Hubnd == "Ice Cream IMango Hubnd" then
                    topos(CFrame.new(-902.56817626953, 79.93204498291, -10988.84765625))
                elseif _G.SelectIMango Hubnd == "Peanut IMango Hubnd" then
                    topos(CFrame.new(-2062.7475585938, 50.473892211914, -10232.568359375))
                elseif _G.SelectIMango Hubnd == "Cake IMango Hubnd" then
                    topos(CFrame.new(-1884.7747802734375, 19.327526092529297, -11666.8974609375))
                elseif _G.SelectIMango Hubnd == "Cocoa IMango Hubnd" then
                    topos(CFrame.new(87.94276428222656, 73.55451202392578, -12319.46484375))
                elseif _G.SelectIMango Hubnd == "Candy IMango Hubnd New⛄" then
                    topos(CFrame.new(-1014.4241943359375, 149.11068725585938, -14555.962890625))
                elseif _G.SelectIMango Hubnd == "Tiki Outpost New" then
                ...
                _G.TeleportIMango Hubnd = false
                StopTween(_G.TeleportIMango Hubnd)
            end
            until not _G.TeleportIMango Hubnd
        end
        StopTween(_G.TeleportIMango Hubnd)
    end    
})
...
LC:AddToggle({
    Name = "Teleport To Mirage IMango Hubnd",
    Default = false,
    Flag = "Teleport to Mirage",
    Save = true,
    Callback = function(Value)
        _G.AutoMysticIMango Hubnd = Value
        StopTween(_G.AutoMysticIMango Hubnd)
    end    
})
...
local Elite_Hunter_Status = SV:AddLabel("Only Third Sea")
      ...
      if World3 then
        spawn(function()
            pcall(function()
                while wait() do
        if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage IMango Hubnd') then
        ...
        spawn(function()
            ...
            spawn(function()
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('IMango Hubnd 1') then
                checkiMango Hubnd:Set(' IMango Hubnd : 1')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('IMango Hubnd 2') then
                checkiMango Hubnd:Set('IMango Hubnd : 2')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('IMango Hubnd 3') then
                checkiMango Hubnd:Set('IMango Hubnd : 3')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('IMango Hubnd 4') then
                checkiMango Hubnd:Set('IMango Hubnd : 4')
                end
                end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('IMango Hubnd 5') then
                checkiMango Hubnd:Set('IMango Hubnd : 5')
                        end
                    end
                    end)
                end)
                        ...
                        while wait() do
                            if _G.AutoBuyChip then
                                if not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") or not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
                                    if not game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 1") then
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc", "Select", _G.SelectChip)
                                    end
                                end
                            end
                        ...
                        pcall(function()
                            if _G.Auto_StartRaid then
                                if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false then
                                    if not game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 1") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
                                        if World2 then
                                            fireclickdetector(game:GetService("Workspace").Map.CircleIMango Hubnd.RaidSummon2.Button.Main.ClickDetector)
                                        elseif World3 then
                        ...
                        pcall(function()
                            while wait() do
                                if _G.Auto_Dungeon then
                                    if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                                        if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 5") then
                                            topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 5").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 4") then
                                            topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 4").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 3") then
                                            topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 3").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 2") then
                                            topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 2").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 1") then
                                            topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("IMango Hubnd 1").CFrame*RaidPos)
                                        end
                                    end
                                end
                            end
                        ...
                        if _G.Auto_Start_Law_Dungeon then
                            pcall(function()
                                if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Microchip") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Microchip") then
                                    fireclickdetector(game:GetService("Workspace").Map.CircleIMango Hubnd.RaidSummon.Button.Main.ClickDetector)
                                end
                            end)
                        end
                    end
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                            if _G.AutoMysticIMango Hubnd then
                                    repeat
                                        wait()
                                    until game:GetService("Workspace").Map:FindFirstChild("MysticIMango Hubnd")
                                    if game:GetService("Workspace").Map:FindFirstChild("MysticIMango Hubnd") then
                                        AllNPCS = getnilinstances()
                                        for r, v in pairs(game:GetService("Workspace").NPCs:GetChildren()) do
                                            table.insert(AllNPCS, v)
    ...
    pcall(function()
        while wait() do
            if _G.TweenMGear then
                if game:GetService("Workspace").Map:FindFirstChild("MysticIMango Hubnd") then
                    for i,v in pairs(game:GetService("Workspace").Map.MysticIMango Hubnd:GetChildren()) do 
                        if v:IsA("MeshPart")then 
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Mango Hub Hub(Noitification)",
        ...
        while wait() do
            if _G.AutoObservation then
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    ...
                    elseif World3 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Giant IMango Hubnder") then
                            if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                                repeat task.wait()
                                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Giant IMango Hubnder").HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                                until _G.AutoObservation == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                            else
                                repeat task.wait()
                                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Giant IMango Hubnder").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                    wait(1)
                                    if not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and _G.AutoObservation_Hop == true then
                                        game:GetService("TeleportService"):Teleport(game.PlaceId,game:GetService("Players").LocalPlayer)
                                    end
...
spawn(function()
	while wait() do
	if World3 and _G.AutoPullLever and not dagatcanmemay and IsMirageIMango Hubnd2() then
	if CheckSea(3) then
             ...
             if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                ...
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Skypiea" then
                    for i,v in pairs(game:GetService("Workspace").Map.SkyTrial.Model:GetDescendants()) do
                        if v.Name ==  "snowiMango Hubnd_Cylinder.081" then
...
spawn(function()
    ...
    spawn(function()
        ...
        if _G.Hopfinddao then
            if game:GetService("Workspace").Map:FindFirstChild("MysticIMango Hubnd") or game:GetService("Workspace").Map:FindFirstChild("MysticIMango Hubnd") then
            ...
            elseif not game:GetService("Workspace").Map:FindFirstChild("MysticIMango Hubnd") or not game:GetService("Workspace").Map:FindFirstChild("MysticIMango Hubnd") then
                Hop()
                end
            end
        end
